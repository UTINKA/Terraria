...
namespace Terraria.GameContent.UI
{
  public class CustomCurrencySingleCoin : CustomCurrencySystem
  {
    ...
    public override void GetPriceText(string[] lines, ref int currentLine, int price)
    {
      ...
      lines[currentLine++] = string.Format("[c/{0:X2}{1:X2}{2:X2}:{3} {4} {5}]", (object) color.R, (object) color.G, (object) color.B, (object) Lang.tip[50], (object) price, (object) Language.GetTextValue(this.CurrencyTextKey).ToLower());
    }
  }
}
