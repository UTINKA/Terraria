			...
			for (int i = 0; i < 6000; i++)
			{
				...
				if (i < Main.numDust)
				{
					if (dust.active)
					{
							...
							else
							{
								...
								else
								{
									...
									else
									{
										...
										{
											if (dust.type == 160 || dust.type == 162)
											{
											...
											else
											{
												...
												{
													if (dust.type >= 139 && dust.type < 143)
													{
													...
													{
														if (dust.type == 14 || dust.type == 16 || dust.type == 31 || dust.type == 46 || dust.type == 124 || dust.type == 186 || dust.type == 188)
														{
														...
														else
														{
															...
															else
															{
																...
																{
																	if (dust.type == 15 || dust.type == 57 || dust.type == 58)
																	{
																							...
																							else
																							{
																								...
																								else
																								{
																									...
																									else
																									{
																										...
																										{
																											if (dust.type == 55 || dust.type == 56 || dust.type == 73 || dust.type == 74)
																											{
																												dust.velocity *= 0.98f;
																											...
																											else
																											{
																												...
																												else
																												{
																													...
																													{
																														if (!dust.noGravity && dust.type != 41 && dust.type != 44)
																														{
																															if (dust.type == 107)
																															{
																																dust.velocity *= 0.9f;
						...
						{
							if (dust.type == 152 && dust.noGravity)
							{
								dust.scale += 0.03f;
								if (dust.scale < 1f)
								{
						...
						{
							if (dust.type >= 219 && dust.type <= 223)
							{
