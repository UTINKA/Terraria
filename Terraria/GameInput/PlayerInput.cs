...
namespace Terraria.GameInput
{
  public class PlayerInput
  {
    ...
    private static void GamePadInput()
    {
      ...
      {
        if (PlayerInput.CheckRebindingProcessGamepad(((Buttons) 2097152).ToString()))
          return;
        KeyConfiguration keyConfiguration = inputMode;
        TriggersSet current = PlayerInput.Triggers.Current;
        buttons = (Buttons) 2097152;
      ...
      if (!PlayerInput.CursorIsBusy)
      {
        ...
        if (((!Vector2.op_Equality(player.velocity, Vector2.get_Zero()) || !Vector2.op_Equality(gamepadThumbstickLeft, Vector2.get_Zero()) ? 0 : (Vector2.op_Equality(gamepadThumbstickRight, Vector2.get_Zero()) ? 1 : 0)) & (flag6 ? 1 : 0)) != 0)
        ...
        case PresetProfiles.Redigit:
          switch (mode)
          {
            ...
            case InputMode.KeyboardUI:
              ...
              c.KeyStatus["Inventory"].Add(((Keys) 27).ToString());
    ...
    public static void SetZoom_Test()
    {
      ...
      Vector2.op_Subtraction(vector2_5, vector2_9);
      float num1 = (float) (1.0 / Main.GameViewMatrix.Zoom.X);
      float num2 = 1f;
      Vector2 vector2_10 = Vector2.op_Addition(Vector2.op_Subtraction(vector2_1, Main.screenPosition), Vector2.op_Multiply(vector2_6, num1));
      Vector2 vector2_11 = Vector2.op_Addition(Vector2.op_Subtraction(vector2_1, Main.screenPosition), Vector2.op_Multiply(vector2_7, num1));
      Vector2 vector2_12 = Vector2.op_Addition(vector2_1, Vector2.op_Multiply(vector2_8, num2));
    ...
    public static void SetZoom_MouseInWorld()
    {
      ...
      Vector2 vector2_6 = Vector2.op_Subtraction(vector2_3, vector2_5);
      float num = (float) (1.0 / Main.GameViewMatrix.Zoom.X);
      Vector2 vector2_7 = Vector2.op_Addition(Vector2.op_Subtraction(vector2_1, Main.screenPosition), Vector2.op_Multiply(vector2_4, num));
      Main.mouseX = (int) vector2_7.X;
      Main.mouseY = (int) vector2_7.Y;
      Vector2 vector2_8 = Vector2.op_Addition(Vector2.op_Subtraction(vector2_1, Main.screenPosition), Vector2.op_Multiply(vector2_6, num));
