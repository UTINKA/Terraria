...
namespace Terraria.Graphics.Capture
{
  public class CaptureInterface
  {
    ...
    public static void QuickScreenshot()
    {
      ...
      Point tileCoordinates1 = Main.screenPosition.ToTileCoordinates();
      Point tileCoordinates2 = (Main.screenPosition + new Vector2((float) Main.screenWidth, (float) Main.screenHeight)).ToTileCoordinates();
