...
namespace Terraria.Graphics.Capture
{
  public class CaptureInterface
  {
    ...
    {
      int num1 = Math.Min((int) CaptureInterface.EdgeA.X, (int) CaptureInterface.EdgeB.X);
      int num2 = Math.Min((int) CaptureInterface.EdgeA.Y, (int) CaptureInterface.EdgeB.Y);
      int num3 = Math.Abs((int) (CaptureInterface.EdgeA.X - CaptureInterface.EdgeB.X));
      int num4 = Math.Abs((int) (CaptureInterface.EdgeA.Y - CaptureInterface.EdgeB.Y));
      int num5 = num2;
      int num6 = num3 + 1;
      int num7 = num4 + 1;
      return new Rectangle(num1, num5, num6, num7);
    }
    ...
    public static void QuickScreenshot()
    {
      ...
      CaptureSettings settings = new CaptureSettings();
      settings.Area = new Rectangle((int) tileCoordinates1.X, (int) tileCoordinates1.Y, tileCoordinates2.X - tileCoordinates1.X + 1, tileCoordinates2.Y - tileCoordinates1.Y + 1);
    ...
    private void DrawButtons(SpriteBatch sb)
    {
      ...
      for (int index = 0; index < num1; ++index)
      {
        ...
        if (index != 1)
        {
          if (index != 5)
          {
            if (index == 7 && Main.graphics.get_IsFullScreen())
              flag = true;
          }
    ...
    private static bool GetMapCoords(int PinX, int PinY, int Goal, out Point result)
    {
      ...
      __Null x = Main.mapFullscreenPos.X;
      float y = (float) Main.mapFullscreenPos.Y;
      double num11 = (double) mapFullscreenScale;
      double num12 = x * num11;
      float num13 = y * mapFullscreenScale;
      float num14 = (float) -num12 + (float) (Main.screenWidth / 2);
      float num15 = -num13 + (float) (Main.screenHeight / 2);
      float num16 = num14 + num6 * mapFullscreenScale;
      float num17 = num15 + num7 * mapFullscreenScale;
      ...
      {
        float num25 = num18 * 0.999f;
        num21 = num19 - 40.6f * num25;
        num22 = num17 - 5f * num25;
        num23 = (width - 8.045f) * num25;
        float num26 = (height + 0.12f) * num25;
        if ((double) num25 < 1.2)
          num24 = num26 + 1f;
      }
      else if (Main.maxTilesX == 6400)
      {
        float num25 = num18 * 1.09f;
        num21 = num19 - 38.8f * num25;
        num22 = num17 - 3.85f * num25;
        num23 = (width - 13.6f) * num25;
      ...
      {
        float num25 = num18 * 1.09f;
        num21 = num19 - 39.8f * num25;
        num22 = num17 - 4.08f * num25;
        num23 = (width - 26.69f) * num25;
        float num26 = (height - 6.92f) * num25;
        if ((double) num25 < 1.2)
          num24 = num26 + 2f;
      }
      ...
      {
        float num25 = num18 * 0.998f;
        num21 = num19 - 37.3f * num25;
        num22 = num20 - 1.7f * num25;
        num23 = (width - 16f) * num25;
        num24 = (height - 8.31f) * num25;
      }
      if (Goal == 0)
      {
        int num25 = (int) ((-(double) num16 + (double) PinX) / (double) mapFullscreenScale + (double) num6);
        int num26 = (int) ((-(double) num17 + (double) PinY) / (double) mapFullscreenScale + (double) num7);
        bool flag = false;
        if ((double) num25 < (double) num6)
          flag = true;
        if ((double) num25 >= (double) num8)
          flag = true;
        if ((double) num26 < (double) num7)
          flag = true;
        if ((double) num26 >= (double) num9)
          flag = true;
        if (!flag)
        {
          result = new Point(num25, num26);
          return true;
        }
        result = new Point(-1, -1);
        return false;
      ...
      if (Goal == 1)
      {
        Vector2 vector2_1;
        // ISSUE: explicit reference operation
        ((Vector2) @vector2_1).\u002Ector(num16, num17);
    ...
    private class ModeEdgeSelection : CaptureInterface.CaptureInterfaceMode
    {
      ...
      private void DrawMarkedArea(SpriteBatch sb)
      {
        ...
        else
        {
          ...
          // ISSUE: explicit reference operation
          ((Rectangle) @rectangle1).\u002Ector((int) result1.X, (int) result1.Y, (int) (result2.X - result1.X), (int) (result2.Y - result1.Y));
          Rectangle rectangle2;
          // ISSUE: explicit reference operation
          ((Rectangle) @rectangle2).\u002Ector(0, 0, Main.screenWidth + 1, Main.screenHeight + 1);
          Rectangle rectangle3;
          Rectangle.Intersect(ref rectangle2, ref rectangle1, ref rectangle3);
          if (rectangle3.Width == null || rectangle3.Height == null)
            return;
        ...
        else
        {
          ...
          else
          {
            ...
            if (CaptureInterface.EdgeBPinned)
            {
              ...
              __Null& local1 = @result1.X;
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              int num6 = ^(int&) local1 + num4;
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              ^(int&) local1 = num6;
              // ISSUE: explicit reference operation
              // ISSUE: variable of a reference type
              __Null& local2 = @result1.Y;
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              int num7 = ^(int&) local2 + num5;
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              ^(int&) local2 = num7;
              ...
              // ISSUE: explicit reference operation
              // ISSUE: variable of a reference type
              __Null& local3 = @result2.X;
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              int num8 = ^(int&) local3 + (1 - num4);
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              ^(int&) local3 = num8;
              // ISSUE: explicit reference operation
              // ISSUE: variable of a reference type
              __Null& local4 = @result2.Y;
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              int num9 = ^(int&) local4 + (1 - num5);
              // ISSUE: cast to a reference type
              // ISSUE: explicit reference operation
              ^(int&) local4 = num9;
    ...
    private class ModeDragBounds : CaptureInterface.CaptureInterfaceMode
    {
      ...
      public void DrawMarkedArea(SpriteBatch sb)
      {
        ...
        else
        {
          ...
          Rectangle rectangle2;
          // ISSUE: explicit reference operation
          ((Rectangle) @rectangle2).\u002Ector((int) result1.X, (int) result1.Y, (int) (result2.X - result1.X), (int) (result2.Y - result1.Y));
          Rectangle rectangle3;
          // ISSUE: explicit reference operation
          ((Rectangle) @rectangle3).\u002Ector(0, 0, Main.screenWidth + 1, Main.screenHeight + 1);
          Rectangle.Intersect(ref rectangle3, ref rectangle2, ref rectangle1);
          if (rectangle1.Width == null || rectangle1.Height == null)
            return;
          // ISSUE: explicit reference operation
