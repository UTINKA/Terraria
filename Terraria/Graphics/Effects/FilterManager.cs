  ...
  public class FilterManager : EffectManager<Filter>
  {
    ...
    public void EndCapture()
    {
      ...
      if ((double) Main.player[Main.myPlayer].gravDir == -1.0)
      {
        ...
        Main.spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend, SamplerState.LinearClamp, DepthStencilState.Default, RasterizerState.CullNone, (Effect) null, Matrix.Invert(Main.Transform));
      ...
      graphicsDevice.Clear(Color.Black);
      if ((double) Main.player[Main.myPlayer].gravDir == -1.0)
        Main.spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend, SamplerState.LinearClamp, DepthStencilState.Default, RasterizerState.CullNone, (Effect) null, Main.Transform);
      else
        Main.spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend);
      if (filter1 != null)
      {
