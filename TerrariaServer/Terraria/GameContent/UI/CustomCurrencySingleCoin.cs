...
namespace Terraria.GameContent.UI
{
  public class CustomCurrencySingleCoin : CustomCurrencySystem
  {
    ...
    public override void GetPriceText(string[] lines, ref int currentLine, int price)
    {
      ...
      // ISSUE: explicit reference operation
      // ISSUE: explicit reference operation
      string str = string.Format("[c/{0:X2}{1:X2}{2:X2}:{3} {4} {5}]", (object) ((Color) @color).get_R(), (object) ((Color) @color).get_G(), (object) ((Color) @color).get_B(), (object) Lang.tip[50].Value, (object) price, (object) Language.GetTextValue(this.CurrencyTextKey).ToLower());
      strArray[index] = str;
    }
  }
}
