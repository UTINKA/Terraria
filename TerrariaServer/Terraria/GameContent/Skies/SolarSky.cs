  ...
  public class SolarSky : CustomSky
  {
    ...
    public override void Update(GameTime gameTime)
    {
      ...
      for (int index = 0; index < this._meteors.Length; ++index)
      {
        ...
        __Null& local1 = @this._meteors[index].Position.X;
        // ISSUE: cast to a reference type
        // ISSUE: explicit reference operation
        double num2 = (double) ^(float&) local1 - (double) num1 * gameTime.get_ElapsedGameTime().TotalSeconds;
        // ISSUE: cast to a reference type
        // ISSUE: explicit reference operation
        ^(float&) local1 = (float) num2;
        // ISSUE: explicit reference operation
        // ISSUE: variable of a reference type
        __Null& local2 = @this._meteors[index].Position.Y;
        // ISSUE: cast to a reference type
        // ISSUE: explicit reference operation
        double num3 = (double) ^(float&) local2 + (double) num1 * gameTime.get_ElapsedGameTime().TotalSeconds;
        // ISSUE: cast to a reference type
        // ISSUE: explicit reference operation
