...
namespace Terraria
{
  public class Recipe
  {
    ...
    {
      RecipeGroupID.Birds = RecipeGroup.RegisterGroup("Birds", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Main.npcName[74]), new int[3]
      {
        2015,
        2016,
        2017
      }));
      RecipeGroupID.Scorpions = RecipeGroup.RegisterGroup("Scorpions", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Main.npcName[367]), new int[2]
      {
        2157,
        2156
      }));
      RecipeGroupID.Squirrels = RecipeGroup.RegisterGroup("Squirrels", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Main.npcName[299]), new int[2]
      {
        2018,
        3563
      }));
      RecipeGroupID.Bugs = RecipeGroup.RegisterGroup("Bugs", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[85]), new int[3]
      {
        3194,
        3192,
        3193
      }));
      RecipeGroupID.Ducks = RecipeGroup.RegisterGroup("Ducks", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[86]), new int[2]
      {
        2123,
        2122
      }));
      RecipeGroupID.Butterflies = RecipeGroup.RegisterGroup("Butterflies", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[87]), new int[8]
      {
        1998,
        2001,
        1994,
      ...
      RecipeGroupID.Fireflies = RecipeGroup.RegisterGroup("Fireflies", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[88]), new int[2]
      {
        1992,
        2004
      }));
      RecipeGroupID.Snails = RecipeGroup.RegisterGroup("Snails", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[95]), new int[2]
      {
        2006,
        2007
      }));
    ...
    public static void SetupRecipes()
    {
      ...
      Recipe.newRecipe.requiredTile[0] = 16;
      Recipe.AddRecipe();
      for (int Type22 = 3665; Type22 <= 3704; ++Type22)
      {
        Recipe.newRecipe.createItem.SetDefaults(Type22, false);
        Recipe.newRecipe.requiredItem[0].SetDefaults(ItemID.Sets.TextureCopyLoad[Type22], false);
      ...
      Recipe.newRecipe.anyWood = true;
      Recipe.AddRecipe();
      for (int Type22 = 2114; Type22 <= 2118; ++Type22)
      {
        Recipe.newRecipe.createItem.SetDefaults(Type22, false);
        Recipe.newRecipe.requiredItem[0].SetDefaults(9, false);
        Recipe.newRecipe.requiredItem[0].stack = 12;
      ...
      {
        Recipe.newRecipe.createItem.SetDefaults(numArray[index1, 0], false);
        int index2 = 0;
        ...
        int Type22 = numArray[index1, 2];
        if (Type22 != -1)
        {
          int index4;
          Recipe.newRecipe.requiredItem[index4 = index2 + 1].SetDefaults(Type22, false);
